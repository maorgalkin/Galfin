...
const Dashboard: React.FC = () => {
  ...
  const [isJoinHouseholdModalOpen, setIsJoinHouseholdModalOpen] = useState(false);
  const [isLeaveHouseholdModalOpen, setIsLeaveHouseholdModalOpen] = useState(false);
  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="mt-4 space-y-2">
              <button
                onClick={() => setIsJoinHouseholdModalOpen(true)}
              ...
              <button
                onClick={() => setIsLeaveHouseholdModalOpen(true)}
      ...
      />
      <JoinHouseholdModal
        isOpen={isJoinHouseholdModalOpen}
        onClose={() => setIsJoinHouseholdModalOpen(false)}
      />
      <LeaveHouseholdModal
        isOpen={isLeaveHouseholdModalOpen}
        onClose={() => setIsLeaveHouseholdModalOpen(false)}
      />
