...
const BudgetSettings: React.FC<BudgetSettingsProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-11/12 max-w-6xl shadow-lg rounded-md bg-white flex flex-col max-h-[90vh]">
        {/* Fixed Header */}
        ...
        <div className="overflow-y-auto flex-1 px-5">
          {/* Tab Navigation */}
          <div className="flex border-b border-gray-200 my-6 sticky top-0 bg-white z-10 pb-0">
            <button
        ...
        {/* Fixed Footer */}
        <div className="flex justify-end space-x-3 p-5 border-t border-gray-200 flex-shrink-0 bg-white">
          <button
            onClick={onClose}
